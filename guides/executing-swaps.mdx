...
description: "End-to-end Vulcx swap on Fogo: get a quote, build the transaction, then sign and submit with @solana/web3.js — complete runnable cURL, TypeScript, and Python code."
