...
Mintlify documentation site for **Vulcx** — a swap aggregator / routing engine on **Fogo Chain** (Solana support is documented as "coming soon"). This is the public developer docs surface; it documents three sibling projects that live elsewhere in the `mono_vulcx` umbrella:
