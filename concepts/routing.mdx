...
For common pairs with deep liquidity (e.g., SOL/USDC), a single pool often provides the best price. Vulcx compares rates across all supported pools and picks the one with the lowest price impact.
