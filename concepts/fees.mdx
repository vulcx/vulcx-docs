...
llmDescription: "Vulcx fee structure on Fogo. Covers pool fees (set by DEX operators like Vortex, Fluxbeam, Fogo.fun, and Moonit, shown in feeBps), aggregator protocol fees (shown in feeAmount), and the no-hidden-fees guarantee where amountIn/amountOut already account for all fees."
---
