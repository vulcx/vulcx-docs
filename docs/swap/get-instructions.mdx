...
<ParamField body="referrer" type="string">
  Optional referrer wallet (base58). Earns the protocol's on-chain referral share of the swap fee,
...
<ParamField body="sessionAccount" type="string">
  ...
  Vortex-V1-only. See [Widget → Fogo Sessions](/widget/wallet-integration#fogo-sessions--firm-mode-no-wallet-popup).
</ParamField>
