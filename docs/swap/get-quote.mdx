...
<ResponseField name="routes" type="RouteInfo[]">
  ...
  <Expandable title="RouteInfo fields">
    ...
    <ResponseField name="poolType" type="string">Pool type. On Fogo: `Vortex`, `Fluxbeam`, `Fogo.fun`, `Moonit`.</ResponseField>
