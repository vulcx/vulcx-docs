---
title: "Swap Overview"
description: "The Vulcx swap lifecycle on SVM chains: quote, build or get instructions, then sign and submit. When to use /swap vs /instructions, ExactIn vs ExactOut, and supported DEXs."
llmDescription: "Overview of the Vulcx swap lifecycle on SVM chains (live on Fogo): get quote, build transaction or get instructions, sign and submit. Explains when to use POST /swap vs POST /instructions, ExactIn vs ExactOut swap modes, Fogo capabilities (5 max hops, Valiant/Fluxbeam DEXs), supported tokens, and links to detailed pages for each step."
---
...
- Fluxbeam (constant product and bonding curve)
