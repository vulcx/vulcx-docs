...
description: "Build AI agents on Vulcx: how LLMs use llms.txt and skill.md to discover pages and route intents to the quote, swap, and instructions endpoints on Fogo."
