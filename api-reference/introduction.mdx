...
description: "Get started with the Vulcx API on Fogo: base URL, the {success, data, error} response envelope, status codes, authentication, and the full endpoint reference."
