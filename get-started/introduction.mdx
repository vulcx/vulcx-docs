...
description: "Vulcx is a swap aggregator on Fogo with multi-hop routing across Vortex, Fluxbeam, Moonit, and more."
...
- **Best-price routing.** Multi-hop routing across Vortex, Fluxbeam, and Moonit bonding curves to find optimal execution.
