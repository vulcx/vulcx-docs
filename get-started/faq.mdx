...
sidebarTitle: "FAQ"
description: "Frequently asked questions about the Vulcx API."
llmDescription: "Frequently asked questions about Vulcx. Covers supported chains (Fogo live, Solana coming soon), P-Token benefits preview, supported tokens on Fogo (Vortex, Fluxbeam, Fogo.fun, Moonit), quote freshness, devnet support, transaction size limits, ExactIn vs ExactOut, fee structure, rate limits, multi-hop behavior, and how to monitor API status."
---
...
When Solana launches, Vulcx will use **P-Token**, an optimized token program that enables:
