...
Limits are per API key by plan — free: 5 requests/second sustained, burst 10 (all beta keys); pro: 50 rps; scale: 150 rps; enterprise: 500 rps. If you hit a `429` response, use exponential backoff (1s, 2s, 4s). Contact the team for higher limits for production integrations.
</Accordion>
